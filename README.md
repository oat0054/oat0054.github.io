...
* Power Query (M Language) scripts used for data cleaning and transformation can be found [here.](<Power Query (M) Script Folder/README.md>)
* DAX Measures used to calculate business logic (e.g., % Loss Rate, Effective Forecast) can be found [here.](<Dax Measures Script Folder>).
